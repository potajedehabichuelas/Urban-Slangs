...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        else
        {
            ...
            self.backgroundBlurView.alpha = 0.6;
        ...
        if (fontName != nil) {
            ...
            [self.titleLabel setFont:[UIFont fontWithName:@"AvenirNext-Bold" size:fontSize]];
        }
        ...
        if ([subtitle length])
        {
            ...
            if (fontName != nil) {
                ...
                [self.contentLabel setFont:[UIFont fontWithName:@"AvenirNext-Regular" size:fontSize]];
            }
